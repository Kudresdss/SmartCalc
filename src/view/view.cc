...
void View::ConnectAll() {
    connect(ui->buttonGroup_print, SIGNAL(buttonClicked(QAbstractButton*)), this, SLOT(
            PrintInLineEdit(QAbstractButton * )));
    ...
    connect(ui->verticalSlider_graph, SIGNAL(sliderMoved(int)), this, SLOT(
            StartSmartCalculator_InputNotChanged_SignalToModel()));
    connect(ui->lineEdit_x_min, SIGNAL(editingFinished()), this, SLOT(
            StartSmartCalculator_InputNotChanged_SignalToModel()));
    connect(ui->lineEdit_x_max, SIGNAL(editingFinished()), this, SLOT(
            StartSmartCalculator_InputNotChanged_SignalToModel()));
    connect(ui->lineEdit_y_min, SIGNAL(editingFinished()), this, SLOT(
            StartSmartCalculator_InputNotChanged_SignalToModel()));
    connect(ui->lineEdit_y_max, SIGNAL(editingFinished()), this, SLOT(
            StartSmartCalculator_InputNotChanged_SignalToModel()));
