...
TEST(SMART_CALCULATOR_BRACKET_ERRORS, OPENING_BRACKET_IN_THE_END) {
    ...
    ModelInfo test_model_info = test_model->SlotSmartToModel(test_view_info);
    ASSERT_EQ(test_model_info.error,
              "Runtime error: incorrect usage of brackets: opening bracket in the end of expression");
}
...
TEST(SMART_CALCULATOR_BRACKET_ERRORS, CLOSING_BRACKET_IN_THE_BEGINNING) {
    ...
    ModelInfo test_model_info = test_model->SlotSmartToModel(test_view_info);
    ASSERT_EQ(test_model_info.error,
              "Runtime error: incorrect usage of brackets: closing bracket in the beginning of expression");
}
...
TEST(SMART_CALCULATOR_EQUATION_CONSTRUCTION_ERRORS, BINARY_FUNCTION_IN_THE_BEGINNING) {
    ...
    ModelInfo test_model_info = test_model->SlotSmartToModel(test_view_info);
    ASSERT_EQ(test_model_info.error,
              "Runtime error: incorrect usage of functions: binary function in the beginning of expression");
}
...
TEST(SMART_CALCULATOR_EQUATION_CONSTRUCTION_ERRORS, BINARY_FUNCTION_IN_THE_END) {
    ...
    ModelInfo test_model_info = test_model->SlotSmartToModel(test_view_info);
    ASSERT_EQ(test_model_info.error,
              "Runtime error: incorrect usage of functions: binary function in the end of expression");
}
...
TEST(SMART_CALCULATOR_EQUATION_CONSTRUCTION_ERRORS, UNARY_FUNCTION_IN_THE_END) {
    ...
    ModelInfo test_model_info = test_model->SlotSmartToModel(test_view_info);
    ASSERT_EQ(test_model_info.error,
              "Runtime error: incorrect usage of functions: unary function in the end of expression");
}
...
TEST(SMART_CALCULATOR_EQUATION_CONSTRUCTION_ERRORS, BINARY_FUNCTION_AFTER_AN_UNARY) {
    ...
    ModelInfo test_model_info = test_model->SlotSmartToModel(test_view_info);
    ASSERT_EQ(test_model_info.error,
              "Runtime error: incorrect usage of functions: binary function after an unary function");
}
